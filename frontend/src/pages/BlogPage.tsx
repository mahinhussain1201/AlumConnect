...
import { BookOpen, ArrowRight, Loader2, Heart, Share2, Clock } from 'lucide-react'
                ...
                <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          ...
                          <button className="flex items-center space-x-2 px-4 py-2 rounded-full bg-gray-50 text-gray-600 hover:bg-gray-100 transition-all duration-200">
