...
import { Briefcase, Calendar, Users, ExternalLink, Loader2, Send, CheckCircle, ArrowLeft, Star, MessageCircle, MapPin, Clock, DollarSign, Code, Building } from 'lucide-react'
                ...
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                  <div className="p-8">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {parseJsonField(project.skills_required).map((skill: string) => (
                        <Badge 
                          key={skill} 
                          variant="default" 
